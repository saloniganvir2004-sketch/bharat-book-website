    ...
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-[#050B15] border-t border-b border-[#C9973E]/20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-12">
        ...
        <div className="relative pt-6 pb-2">
          ...
          {/* Timeline Nodes (Clean, minimal era titles) */}
          <div className="grid grid-cols-1 lg:grid-cols-7 gap-6 lg:gap-3 relative z-10">
            {periods.map((period, idx) => (
              ...
              >
                {/* Node Point */}
                <div className="absolute lg:relative left-3 lg:left-auto flex items-center justify-center w-7 h-7 rounded-full bg-[#07101F] border-2 border-[#C9973E] group-hover:bg-[#C9973E] group-hover:scale-110 transition-all duration-300 shadow-[0_0_10px_rgba(201,151,62,0.3)] mb-0 lg:mb-3">
                  <div className="w-2 h-2 rounded-full bg-[#C9973E] group-hover:bg-[#07101F] transition-colors" />
                </div>

                {/* Era Title Only */}
                <div className="p-3.5 rounded-sm bg-[#0B1628]/90 border border-[#C9973E]/15 group-hover:border-[#C9973E]/50 transition-all duration-300 w-full shadow-md">
                  <h3 className="font-cinzel text-xs font-bold tracking-[0.15em] text-[#F2EBDD] group-hover:text-[#E5B869] transition-colors text-center">
                    {period.title}
                  </h3>
                </div>
              </motion.div>
        ...
        <div className="text-center pt-4">
          <a
            href="#the-book"
            className="inline-flex items-center gap-3 px-8 py-3.5 rounded-sm border border-[#C9973E] bg-[#C9973E]/10 text-xs font-bold uppercase tracking-[0.25em] text-[#F2EBDD] hover:bg-[#C9973E] hover:text-[#07101F] transition-all duration-300 shadow-[0_0_20px_rgba(201,151,62,0.2)]"
          >
