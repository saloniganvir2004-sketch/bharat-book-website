...
export function AboutAuthor() {
  return (
    <section id="author" className="relative py-28 px-4 sm:px-6 lg:px-8 bg-[#07101F] overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* LEFT: PREMIUM PORTRAIT PLACEHOLDER */}
          <motion.div
          ...
          >
            ...
            {/* Badges */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4 border-t border-[#C9973E]/20">
