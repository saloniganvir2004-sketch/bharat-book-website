...
export function ComingSoonBuy() {
  return (
    <section id="coming-soon" className="relative py-28 px-4 sm:px-6 lg:px-8 bg-[#07101F] overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* LEFT: PROMINENT OFFICIAL BOOK COVER */}
          <motion.div
          ...
          >
            ...
            {/* Retailer Buttons Container (Configured for future link insertion) */}
            <div className="space-y-4 pt-2">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                ...
                {/* AMAZON BUTTON (Easily edit href property later) */}
                <a
                  href="#coming-soon"
                  className="w-full sm:w-auto min-w-[200px] flex items-center justify-between gap-4 px-6 py-4 rounded-sm border border-[#C9973E]/50 bg-[#0B1628] hover:bg-[#0B1628]/90 text-[#F2EBDD] transition-all cursor-not-allowed opacity-95 group shadow-lg"
                  title="Amazon purchasing link will activate upon publication"
                >
                ...
                {/* FLIPKART BUTTON (Easily edit href property later) */}
                <a
                  href="#coming-soon"
                  className="w-full sm:w-auto min-w-[200px] flex items-center justify-between gap-4 px-6 py-4 rounded-sm border border-[#C9973E]/50 bg-[#0B1628] hover:bg-[#0B1628]/90 text-[#F2EBDD] transition-all cursor-not-allowed opacity-95 group shadow-lg"
            ...
            {/* Subtext */}
            <div className="flex items-center justify-center lg:justify-start gap-2 text-xs font-mono tracking-[0.25em] text-[#A3B1C6] pt-2">
